    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    <a href="/dashboard" class="nav_link"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Panel Administrativo</span> </a>
                    <a href="{{route('areas.index')}}" class="nav_link"> <i class='bx bx-user nav_icon'></i> <span class="nav_name">Áreas</span> </a>
                    <a href="{{ route('metas') }}" class="nav_link"> <i class='bx bx-message-square-detail nav_icon'></i> <span class="nav_name">Metas</span> </a>
                    <a href="#" class="nav_link"> <i class='bx bx-bookmark nav_icon'></i> <span class="nav_name">Usuarios</span> </a>
                    <a href="{{ route('programas.index') }}" class="nav_link"> <i class='bx bx-folder nav_icon'></i> <span class="nav_name">Programas</span> </a>
